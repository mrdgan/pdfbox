...
public class PDFText2HTML extends PDFTextStripper
{
    ...
    private class FontState {
         ...
         * by its font state.
         */
        public String push(String text, List<TextPosition> textPositions) throws IOException {
        ...
        protected String push(StringBuilder buffer, char character, TextPosition textPosition) throws IOException {
            boolean bold = false;
            ...
            int fonsize = (int) textPosition.getFontSize();
            String fontname = descriptor.getFontName();
            buffer.append(open("span style=\"font-size:" + fonsize + "px; font-family:" + fontname + "\""));
            buffer.append(bold ? open("strong") : close("strong"));
        ...
        private int closeUntil(StringBuilder tagsBuilder, String endTag) {
            for (int i = stateList.size(); i-- > 0;) {
                ...
                tagsBuilder.append(closeTag(closeTagConrol(tag)));
        ...
        private String closeTagConrol(String tag) {
            if (tag.contains(" ")) {
